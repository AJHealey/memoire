...
\begin{lstlisting}[frame=single,breaklines=true,caption={Example of trying to authenticate and associate with an AP}]
...
\begin{lstlisting}[frame=single,breaklines=true,caption={Example of an association with an AP}]
wlan0: Trying to associate with 00:1e:bd:65:34:71 (SSID='student.UCLouvain' freq=2437 MHz)
