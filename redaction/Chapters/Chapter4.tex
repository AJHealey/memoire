...
struct ap_tried *first_connect = NULL;
struct ap_tried *curr_connect = NULL;
\end{lstlisting}
...
\begin{description}
	\item[Connection loop]: This is the core part of our monitoring system. Indeed, the loop embeds the key process of our tool. Firstly

	\item[Scan]:

	\item[Services checking process]:
