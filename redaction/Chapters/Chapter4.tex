...
\lhead{Chapter 4. \emph{Monitoring Tool - Implementation and Deployment}} 
...
The \emph{probe} module manages the connection with the probes. When a probe want to connect to the server, it answers and performs the authentication. When the authentication succeeds, the module will receive the log file generated by the probe. Finally, it will analyze it and translate it in the database.
